...
/**
 * Obstacle Domain Model for Canvas Aggregate
 */
final class Obstacle extends CanvasObject {
    ...
    public static function fromPrimitives(object $primitives): self {
        return Obstacle::create(CanvasObjectCoordinatePosition::create($primitives->xPosition),
